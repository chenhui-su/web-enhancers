...
// @downloadURL  https://github.com/chenhui-su/web-enhancers/releases/download/gemini-ui-enhancer%401.0.5/gemini-ui-enhancer.user.js
...
(function() {
    ...
    function init() {
        try {
            ...
            console.log('✓ Gemini UI Enhancer v1.0.5 loaded (Font Fix)');
        } catch (e) {
