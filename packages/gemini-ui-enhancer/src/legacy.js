...
// @downloadURL  https://github.com/chenhui-su/web-enhancers/releases/download/gemini-ui-enhancer%401.0.4/gemini-ui-enhancer.user.js
...
(function() {
        ...
        _generateStaticCSS() {
            return `
                ...
                body.toc-open .input-area-container {
                    width: calc(100% - 20px) !important; margin-right: 320px !important;
                    margin-left: auto !important; max-width: min(var(--w-max-width, 900px), calc(100% - 352px)) !important; min-width: 400px !important;
                }
    ...
    function init() {
        try {
            ...
            console.log('✓ Gemini UI Enhancer v1.0.4 loaded (Font Fix)');
        } catch (e) {
